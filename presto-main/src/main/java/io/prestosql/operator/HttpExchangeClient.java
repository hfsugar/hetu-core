        ...
        implements ExchangeClient
{
            ...
            implements ClientCallback
    {
        ...
        public boolean addPages(HttpPageBufferClient client, List<SerializedPage> pages)
        {
            ...
            return HttpExchangeClient.this.addPages(pages);
        }
        ...
        {
            requireNonNull(client, "client is null");
            HttpExchangeClient.this.requestComplete(client);
        }

        @Override
        public void clientFinished(HttpPageBufferClient client)
        {
            HttpExchangeClient.this.clientFinished(client);
        }
        ...
        public void clientFailed(HttpPageBufferClient client, Throwable cause)
        {
            ...
            HttpExchangeClient.this.clientFailed(cause);
        }
    }
