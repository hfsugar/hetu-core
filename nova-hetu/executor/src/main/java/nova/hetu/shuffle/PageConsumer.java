...
public class PageConsumer
{
    ...
    PageConsumer(ProducerInfo producerInfo, PagesSerde serde)
    {
        ...
        ShuffleClient client = new UcxShuffleClient();
        client.getResults(producerInfo.getHost(), producerInfo.getPort(), producerInfo.getProducerId(), pageOutputBuffer, new ShuffleClientCallbackImpl());
