        ...
        implements ShuffleServer
{
    ...
    private UcxMemoryPool ucxMemoryPool;
    private UcpListener listener;
    private final ShuffleServiceConfig shuffleServiceConfig;

    public UcxServer(ShuffleServiceConfig shuffleServiceConfig)
    {
    ...
    public void start()
    {
        ...
        ucxMemoryPool = new UcxMemoryPool(context, UcxConstant.UCX_MIN_BUFFER_SIZE);
        ucxMemoryPool.preAllocate(UcxConstant.BASE_BUFFER_NB, UcxConstant.UCX_MIN_BUFFER_SIZE);
            ...
            implements Runnable
    {
        private UcpRequest recvRequest()
        {
            ...
            return worker.recvTaggedNonBlocking(setupMessageBuffer, new UcxCallback()
            {
                ...
                {
                    UcxShuffleService shuffleService = new UcxShuffleService(context, ucxMemoryPool, setupMessageBuffer, serverExecutor, shuffleServiceConfig.isZeroCopyEnabled());
